...
import {
    ...
    // resetValue
} from "../../redux/slices/layouts/thunk";
...
const RightSidebar = (props:any) => {
    ...
    useEffect(() => {
        const sidebardark:any = document.getElementById("sidebar-color-dark")
        const sidebarlight:any=  document.getElementById("sidebar-color-light")
        if (show && document.getElementById("sidebar-color-dark") && document.getElementById("sidebar-color-light")) {
            sidebardark.checked = false;
            sidebarlight.checked = false;
        }
    });
