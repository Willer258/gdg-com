...
const OverviewTab = ({ data }: any) => {
  ...
  const membre = data && JSON.parse(data.organizers_team);
        ...
        <Col xl={9} lg={8}>
          <Card>
            <CardBody>
              <div className="text-muted">
                <h6 className="mb-3 fw-semibold text-uppercase">A propos</h6>
                ...
                <div className="pt-3 border-top border-top-dashed mt-4">
                  <Row>
                    <Col lg={3} sm={6}>
                      <div>
                        <p className="mb-2 text-uppercase fw-medium">LIEU</p>
                        <h5 className="fs-15 mb-0">{data.lieu}</h5>
                      </div>
                    </Col>
                    <Col lg={3} sm={6}>
                      <div>
                        <p className="mb-2 text-uppercase fw-medium">Date</p>
                        <h5 className="fs-15 mb-0">{data.date}</h5>
                      </div>
                    </Col>
                    <Col lg={3} sm={6}>
                      <div>
                        <p className="mb-2 text-uppercase fw-medium">Statut</p>
          ...
          <Card>
            <CardHeader className="align-items-center d-flex border-bottom-dashed">
              <h4 className="card-title mb-0 flex-grow-1">Certifiés</h4>
          ...
          <Card>
            ...
            <CardBody>
              ...
              >
                <div className="vstack gap-3">
                  {membre &&
                    membre.map((member: any, index: number) => (
                      <div key={index} className="d-flex align-items-center">
                        <div className="avatar-xs flex-shrink-0 me-3">
                          <div className="avatar-title bg-soft-success text-success rounded-circle">
