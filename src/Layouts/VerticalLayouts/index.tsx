 ...
 */
    ...
    const resizeSidebarMenu = useCallback(() => {
        ...
        const hamburgericon:any = document.querySelector(".hamburger-icon")
        if (windowSize >= 1025) {
    ...
    function activateParentDropdown(item: { classList: { add: (arg0: string) => void; }; closest: (arg0: string) => any; }) {
    ...
    const removeActivation = (items:any) => {
        const actiItems = items.filter((x: { classList: { contains: (arg0: string) => any; }; }) => x.classList.contains("active"));
    ...
    return (
        <React.Fragment>
            {/* menu Items */}
            {(navData || []).map((item: { [x: string]: any; label: any; subItems: any; click: React.MouseEventHandler<HTMLAnchorElement> | undefined; link: To; icon: string | undefined; badgeName: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | React.ReactFragment | null | undefined; badgeColor: string; stateVariables: boolean | undefined; }, key: React.Key | null | undefined) => {
                return (
                                    ...
                                    <li className="nav-item">
                                        ...
                                        <Collapse
                                            ...
                                            <ul className="nav nav-sm flex-column test">
                                                {/* subItms  */}
                                                {item.subItems && ((item.subItems || []).map((subItem: { isChildItem: any; link: To; label: any; badgeName: string | number | boolean | React.ReactElement<any, string | React.JSXElementConstructor<any>> | React.ReactFragment | null | undefined; badgeColor: string; click: React.MouseEventHandler<HTMLAnchorElement> | undefined; stateVariables: boolean | undefined; childItems: any; }, key: React.Key | null | undefined) => (
                                                    <React.Fragment key={key}>
                                                        {!subItem.isChildItem ? (
                                                            <li className="nav-item">
                                                                <Link
                                                            ...
                                                            <li className="nav-item">
                                                                ...
                                                                <Collapse className="menu-dropdown" isOpen={subItem.stateVariables} id="sidebarEcommerce">
                                                                    <ul className="nav nav-sm flex-column">
                                                                        {/* child subItms  */}
                                                                        {subItem.childItems && (
                                                                            (subItem.childItems || []).map((childItem: { childItems: any[]; link: To; label: any; click: React.MouseEventHandler<HTMLAnchorElement> | undefined; stateVariables: boolean | undefined; }, key: React.Key | null | undefined) => (
                                                                                <React.Fragment key={key}>
